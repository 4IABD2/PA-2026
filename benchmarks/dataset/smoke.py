...
def test_instance_packing_format():
    ...
    assert packed[0, 0] == (10 << 16) | (0x12 << 8) | 0x34
...
def test_instance_viz_color_is_deterministic():
    ...
    viz1 = colorize_instance(pack_instance_carla(frame1))
    viz2 = colorize_instance(pack_instance_carla(frame2))
    ...
    assert tuple(colorize_instance(bg)[0, 0]) == (0, 0, 0)
